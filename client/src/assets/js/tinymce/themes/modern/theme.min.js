!(function() {
                ...
                n = function(e, t) {
                    ...
                    if (!x.removed) {
                        ...
                        x.inline || (o.w = x.getDoc().documentElement.offsetWidth),
                            ...
                            (r = R.clamp(r, o)),
                            n
                                ? ((a = R.relativePosition(i, r, n)), F(s, U(u, a.x, a.y, r, o, i)))
                                : ((o.h += i.h),
                                  (r = R.intersect(o, r))
                    ...
                    items: [
                        {
                            ...
                            classes: 'top-part',
                            items: [
                                !1 === d(t) ? null : { type: 'menubar', border: '0 0 1 0', items: se(t) },
                                L(t, f(t)),
                            ],
                        },
                        ge(t)
                    ...
                    e
                        ? ((i = a.deltaW),
                          ...
                          ((t = s._lastLayoutRect).x === a.x && t.y === a.y && t.w === a.w && t.h === a.h) ||
                              ((o = Ge.repaintControls) && o.map && !o.map[s._id] && (o.push(s), (o.map[s._id] = !0)),
                              (t.x = a.x),
                              (t.y = a.y),
                              (t.w = a.w),
                              (t.h = a.h)),
    ...
    var ut = {},
        ct = st.extend({
            ...
            replace: function(e, t) {
                ...
                0 <= r &&
                    ((n = t.getEl()) && n.parentNode.removeChild(n), (n = e.getEl()) && n.parentNode.removeChild(n)),
                    t.parent(this);
            },
            create: function(e) {
                var t,
    ...
    function Et(e, t) {
        ...
        if (wt.length)
            for (n = 0; n < wt.length; n++)
                wt[n].modal && (r++, (i = wt[n])), (wt[n].getEl().style.zIndex = r), (wt[n].zIndex = r), r++;
                ...
                c = function() {
                    a
                        ...
                        : ((a = e.panel = b.create({
                              ...
                              border: 1,
                              items: [
                                  !1 === d(s) ? null : { type: 'menubar', border: '0 0 1 0', items: se(s) },
                                  L(s, f(s)),
                              ],
                          })),
    ...
    function Ft(e) {
        ...
        !1 !== fe.overrideViewPort &&
            ...
            n.setAttribute(
                'content',
                e ? 'width=device-width,initial-scale=1.0,user-scalable=0,minimum-scale=1.0,maximum-scale=1.0' : zt
            ));
    }
    function Ut(e, t) {
        (function() {
            ...
            !1 === t &&
            we([document.documentElement, document.body]).removeClass(e + 'fullscreen');
    }
    var Vt = kt.extend({
        modal: !0,
        Defaults: {
        ...
        recalc: function() {
            var e,
                ...
                r = this,
                o = r.statusbar;
            r._fullscreen && (r.layoutRect(Ce.getWindowSize()), (r.layoutRect().contentH = r.layoutRect().innerH)),
                r._super(),
                (e = r.layoutRect()),
                r.settings.title &&
                    !r._fullscreen &&
    ...
    var Yt = Vt.extend({
        ...
        an = Wt.extend({
            ...
            renderHtml: function() {
                ...
                return (
                    ...
                    (t = Ce.create('div', e, '<span>' + this.translate(n.text) + '</span>')),
        ...
        wn = ('undefined' != typeof window ? window : Function('return this;')(),
        function(e, t) {
            var n = (function(e, t) {
        ...
        Vn = [
            ...
            { name: 'OSX', search: Fn('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
        ...
        ri = function(e) {
            return e.id
                ? e.id
                : ((t = 'h'), (n = new Date().getTime()), t + '_' + Math.floor(1e9 * Math.random()) + ++hn + String(n));
            var t, n;
        },
        oi = function(e) {
        ...
        yi = function(e, t) {
            ...
            /^https?/.test(e) &&
                (o
                    ? ((n = o), (i = e), (r = q(n, i)), -1 === r ? D.none() : D.some(r)).isNone() &&
        ...
        Mi = function(i) {
            var t = ['alignleft', 'aligncenter', 'alignright', 'alignjustify'],
                ...
                e = [
                    ...
                    { text: 'Center', icon: 'aligncenter', onclick: Ti(i, 'aligncenter') },
                    { text: 'Right', icon: 'alignright', onclick: Ti(i, 'alignright') },
                    { text: 'Justify', icon: 'alignjustify', onclick: Ti(i, 'alignjustify') },
                ];
        ...
        Bi = function(n) {
            n.addButton('fontsizeselect', function() {
                var e,
                    s,
                    a,
                    t = ((e = n.settings.fontsize_formats || '8pt 10pt 12pt 14pt 18pt 24pt 36pt'),
        ...
        Zi = function(e) {
            ...
            (t = e).addMenuItem('undo', {
                ...
                (n = e).addButton('undo', { tooltip: 'Undo', onPostRender: Ki(n, 'undo'), cmd: 'undo' }),
            ...
            setup: function(e) {
                ...
                e.rtl && (st.rtl = !0),
                    ...
                    (t = e).settings.ui_container &&
                        (fe.container = ki(gn.fromDom(document.body), t.settings.ui_container).fold(k(null), function(
                            e
                        ) {
                            return e.dom();
                        })),
        ...
        tr = qt.extend({
            recalc: function(e) {
                ...
                if (
                    ...
                    var N;
                    o.autoResize &&
                        (((l = e.layoutRect(l)).contentW = l.minW - o.deltaW), (l.contentH = l.minH - o.deltaH)),
                    ...
                    for (m = p.top, f = 0; f < n; f++) {
                        for (h = p.left, a = M[f] + N, d = 0; d < i && (c = r[H ? f * i + i - 1 - d : f * i + d]); d++)
                            (g = c.settings),
                                (u = c.layoutRect()),
            ...
            initLayoutRect: function() {
                ...
                return (
                    e.settings.multiline &&
                        (Ce.getSize(e.getEl()).width > t.maxW && ((t.minW = t.maxW), e.classes.add('multiline')),
                        (e.getEl().style.width = t.minW + 'px'),
                        (t.startMinH = t.h = t.minH = Math.min(t.maxH, Ce.getSize(e.getEl()).height))),
                    t
                );
            },
            repaint: function() {
    ...
    function vr(e, t) {
        ...
        'v' === e.settings.orientation
            ...
            (s = e.getEl('handle')),
            (o =
                ((e.layoutRect()[n] || 100) - Ce.getSize(s)[i]) * ((t - e._minValue) / (e._maxValue - e._minValue)) +
                'px'),
            (s.style[r] = o),
        ...
        Cr = Wt.extend({
            ...
            renderHtml: function() {
                ...
                return (
                    ...
                    ((e = Ce.create(i.multiline ? 'textarea' : 'input', t)).value = n.state.get('value')),
