!(function() {
    ...
    var n,
        ...
        Ln = [
            ...
            { name: 'Opera', versionRegexes: [zn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: jn('opera') },
            { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: jn('firefox') },
            {
                name: 'Safari',
        ...
        Un = [
            { name: 'Windows', search: jn('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
            {
                name: 'iOS',
                search: function(n) {
            ...
            { name: 'Android', search: jn('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
        ...
        ht = function(n, e) {
            ...
            return 0 < o.errors.length
                ? pt(o.errors)
                : ((t = o.values), (r = e), at.value(C.apply(undefined, [r].concat(t))));
        },
        bt = function(n) {
            var e = vt(n);
        ...
        pr = function(n) {
            if (!Rt(n, 'can') && !Rt(n, 'abort') && !Rt(n, 'run'))
                throw new Error('EventHandler defined by: ' + Bt(n, null, 2) + ' does not have can, abort, or run!');
    ...
    var Zr = function(n, e, t) {
            if (!(b(t) || y(t) || x(t)))
                throw (console.error('Invalid call to Attr.set. Key ', e, ':: Value ', t, ':: Element ', n),
        ...
        bo = {
            ...
            remove: function(n, e) {
                ...
                po(n) ? n.dom().classList.remove(e) : go(n, e),
                    0 === (po((t = n)) ? t.dom().classList : lo(t)).length && ro.remove(t, 'class');
            },
            toggle: function(n, e) {
    ...
    var Co = function(n, e, t) {
                                      ...
                                      console.log(n, {
                                          ...
                                          sequence: yn(r, function(n) {
                                              return hn(['cut', 'stopped', 'response'], n.outcome)
                                                  ? '{' + n.purpose + '} ' + n.outcome + ' at (' + qo(n.target) + ')'
                                                  : n.outcome;
                                          }),
                                      });
                              },
        ...
        Di = function(n) {
            return vi.config({ channels: Et(jo.orientationChanged(), { onReceive: n }) });
        },
        Ai = function(n, e) {
        ...
        zi = function(n, e, t) {
            if (!b(t))
                throw (console.error('Invalid call to CSS.set. Property ', e, ':: Value ', t, ':: Element ', n),
        ...
        _i = {
            ...
            remove: function(n, e) {
                var t = n.dom();
                ji(t, e),
                    ro.has(n, 'style') && '' === ro.get(n, 'style').replace(/^\s+|\s+$/g, '') && ro.remove(n, 'style');
            },
            get: function(n, e) {
                var t = n.dom(),
    ...
    var $i,
        ...
        Vr(rr(Gi.branchKey, Gi.branches), Gi.name, Gi.active, Gi.apis, Gi.extra, Gi.state)),
        ac = function(r, n) {
            return (
                (e = r),
                (t = {}),
        ...
        Vc = function(n, e, t, r) {
            var o = t;
            return C(e.defaults()(n, t, r), t, { uid: n.partUids()[e.name()] }, e.overrides()(n, t, r), {
        ...
        ss = as({
            ...
            factory: function(n) {
                ...
                return {
                    ...
                    events: o,
                    behaviours: C(
                        qr([Vi.config({}), uc.config({ mode: 'execution', useSpace: !0, useEnter: !0 })]),
        ...
        ds = function(n) {
            var e,
                ...
                o = fe.fromHtml(n),
                i = $e.children(o),
                u = ((t = (e = o).dom().attributes !== undefined ? e.dom().attributes : []),
                Sn(
                    t,
                    function(n, e) {
        ...
        ks = function(i, u, a, n) {
            return Os(n).map(function(n) {
                ...
                return (
                    (e = i),
                    (r = n),
                    (o = xs(a, (t = u).min(), t.max(), r, t.stepSize(), t.snapToGrid(), t.snapStart())),
                    Cs(e, o),
                    n
                );
            });
        ...
        Ms = [
            ...
            Ic({
                ...
                overrides: function(n) {
                    return { events: br([Sr(L(), n, 'spectrum'), Sr(U(), n, 'spectrum'), Sr(P(), n, 'spectrum')]) };
                },
            }),
            Ic({
                schema: [
        ...
        _s = [
            gr('store', { mode: 'memory' }, rr('mode', { memory: Ps, manual: Us, dataset: Ls })),
            ai('onSetValue'),
            mr('resetOnDom', !1),
        ],
        Ws = Xr({
        ...
        Zs = function(n) {
            return [
                ...
                Js.sketch({
                    dom: ms('<div class="${prefix}-slider ${prefix}-hue-slider-container"></div>'),
                    components: [
                        Js.parts()['left-edge'](gs('<div class="${prefix}-hue-slider-black"></div>')),
                        Js.parts().spectrum({
                            dom: ms('<div class="${prefix}-slider-gradient-container"></div>'),
                            components: [gs('<div class="${prefix}-slider-gradient"></div>')],
                            behaviours: qr([ki.config({ toggleClass: Mi.resolve('thumb-active') })]),
                        }),
                        Js.parts()['right-edge'](gs('<div class="${prefix}-hue-slider-white"></div>')),
                        Js.parts().thumb({
        ...
        cf = function(n) {
            return [
                ...
                ((e = n),
                tf({ onChange: e.onChange, sizes: af, category: 'font', getInitialValue: e.getInitialValue })),
                gs('<span class="${prefix}-toolbar-button ${prefix}-icon-large-font ${prefix}-icon"></span>'),
            ];
            var e;
        },
        sf = function(n) {
                  ...
                  return (
                      ...
                      (n.all = function() {
                          var c = Array.prototype.slice.call(
                              1 === arguments.length && t(arguments[0]) ? arguments[0] : arguments
                          );
    ...
    function wf(n) {
        ...
        for (
            ...
            for (var m = 1024 * d, g = Math.min(m + 1024, s), v = new Array(g - m), p = m, h = 0; p < g; ++h, ++p)
                v[h] = c[p].charCodeAt(0);
            l[d] = ((r = v), new (Ie.getOrDie('Uint8Array'))(r));
        }
        return B.some(((o = l), (i = { type: u }), new (Ie.getOrDie('Blob'))(o, i)));
    }
    function xf(t) {
        return new vf(function(n, e) {
            wf(t).fold(function() {
    ...
    var Sf,
                ...
                return jf(n).fold(
                    ...
                    function(n) {
                        return (
                            ...
                            (o = ro.get(e, 'title')),
                            (i = ro.get(e, 'target')),
                            { url: Hf(r), text: t !== r ? Hf(t) : '', title: Hf(o), target: Hf(i), link: B.some(e) }
                        );
                        var e, t, r, o, i;
                    }
                );
        ...
        Wf = function(n, e) {
            ...
            return {
                ...
                value: {
                    config: {},
                    me: ((t = n), (r = br(e)), Xr({ fields: [ur('enabled')], name: t, active: { events: E(r) } })),
                    configAsRaw: E({}),
                    initialConfig: {},
                    state: $r,
                },
        ...
        Xf = as({
            ...
            factory: function(t) {
                return {
                    ...
                    behaviours: C(
                        qr([
                            Ws.config({ store: { mode: 'memory', initialValue: t.getInitialValue()() } }),
            ...
            var r = 'navigateEvent',
                ...
                o = function(e, n, t) {
                    return ss.sketch({
                        ...
                        buttonBehaviours: qr([
                            hl.config({ disableClass: Mi.resolve('toolbar-navigation-disabled'), disabled: !t }),
                        ]),
                    });
                },
                i = function(n, o) {
                        ...
                        return {
                                ...
                                Yf.sketch({
                                    ...
                                    components: yn(u.fields, function(n, e) {
                                        return e <= u.maxFieldIndex
                                            ? Yf.sketch({
                                                  dom: ms('<div class="${prefix}-serialised-dialog-screen"></div>'),
                                                  components: Dn([
                                                      [o(-1, 'previous', 0 < e)],
                            ...
                            formBehaviours: qr([
                                Di(function(n, e) {
                                    var t;
                                    (t = e),
                                        ou(n.element(), '.' + Mi.resolve('serialised-dialog-chain')).each(function(n) {
                ...
                s = sf({
                    ...
                    behaviours: qr([
                        Eu.config({ highlightClass: Mi.resolve('dot-active'), itemClass: Mi.resolve('dot-item') }),
                    ]),
                    components: An(u.fields, function(n, e) {
                        return e <= u.maxFieldIndex
                            ? [gs('<div class="${prefix}-dot-item ${prefix}-icon-full-dot ${prefix}-icon"></div>')]
                            : [];
                    }),
                });
            return {
        ...
        jl = function(n, e) {
            return (t = l.apply(undefined, [n.handler].concat(e))), (r = n.purpose()), { cHandler: t, purpose: E(r) };
            var t, r;
        },
        Ll = function(n) {
            return n.cHandler;
        ...
        vd = [
            ...
            li('builder', function(n) {
                return {
                    dom: C(n.dom(), { attributes: { role: n.toggling().isSome() ? 'menuitemcheckbox' : 'menuitem' } }),
                    behaviours: C(
                        qr([
                    ...
                    events: br([
                        wr(gd(), function(e, t) {
                            ...
                            e.getSystem()
                                .getByDom(n.target())
                                .each(function(n) {
                                    Eu.highlight(e, n), t.stop(), ie(e, Td(), { menu: e, item: n });
                                });
                        }),
                        wr(md(), function(n, e) {
                            var t = e.event().item();
                ...
                return {
                    ...
                    behaviours: C(
                        qr([
                            ...
                            Eu.config({ highlightClass: u.markers().selectedMenu(), itemClass: u.markers().menu() }),
                            qf.config({
                                find: function(n) {
        ...
        Hd = function(n, e, t, r) {
            Fd(n, e, t),
                ro.has(n.element(), e.stateAttr()) && ro.get(n.element(), e.stateAttr()) !== r && e.onFinish()(n, r),
            ...
            progressTo: function(t, r, o, i) {
                ...
                (e = r),
                    ro.has((n = t).element(), e.destinationAttr()) &&
                        (ro.set(n.element(), e.stateAttr(), ro.get(n.element(), e.destinationAttr())),
                        ro.remove(n.element(), e.destinationAttr()));
                var u,
                    a,
                    c = ((u = r), (a = i), { start: E(ro.get(t.element(), u.stateAttr())), destination: E(a) });
                Bd(t, r, o, c).fold(
                    function() {
                        Hd(t, r, o, i);
                    },
        ...
        Ld = [
            ...
            ai('onTransition'),
            ai('onFinish'),
            ar('routes', Wt(at.value, Wt(at.value, Pt([dr('transition', [ur('property'), ur('transitionClass')])])))),
        ],
        Ud = Xr({
            fields: Ld,
            name: 'transitioning',
            ...
            extra: {
                ...
                createBistate: function(n, e, t) {
                    return Dt([{ key: n, value: Et(e, t) }, { key: e, value: Et(n, t) }]);
                },
        ...
        $d = function(n, e, t, r, o) {
            return {
                data: { value: n, text: e },
                type: 'item',
                dom: { tag: 'div', classes: o ? [Mi.resolve('styles-item-is-menu')] : [] },
                toggling: { toggleOnExecute: !1, toggleClass: Mi.resolve('format-matches'), selected: t },
                itemBehaviours: qr(
                    o
                        ? []
                        : [
            ...
            return {
                ...
                components: [
                    ss.sketch({
                        ...
                        components: r
                            ? [{ dom: { tag: 'span', classes: [Mi.resolve('styles-collapse-icon')] } }, id(n)]
                            : [id(n)],
                        action: function(n) {
                            if (r) {
                                var e = t().get(n);
                    ...
                    {
                        dom: { tag: 'div', classes: [Mi.resolve('styles-menu-items-container')] },
            ...
            var a = function(n) {
                ...
                s = function(n) {
                    return yn(n, function(n) {
                        if (Rt(n, 'items')) {
                            var e = s(n.items);
                            return C(C(n, { isSelected: E(!1), getPreview: E('') }), { items: e });
                        }
                        return Rt(n, 'format')
            ...
            return function(n) {
                if (m(n)) {
                    var e,
                        ...
                        (u = l),
                        (a = n),
                        { target: E(e), x: E(t), y: E(r), stop: o, prevent: i, kill: u, raw: E(a) });
                    g(d);
                }
            };
        },
                        ...
                        value: function(t) {
                            return (
                                hm(t).each(function(n) {
                                    a.cancel();
                                    var e = { x: E(n.clientX), y: E(n.clientY), target: t.target };
        ...
        Hm = {
            ...
            isWithin: function(n, e) {
                return (
                    e.compareBoundaryPoints(n.END_TO_START, n) < 1 && -1 < e.compareBoundaryPoints(n.START_TO_END, n)
                );
            },
            toString: function(n) {
                return n.toString();
        ...
        _m = (document.caretPositionFromPoint || document.caretRangeFromPoint,
        function(n, e) {
            var t = be.name(n);
            return 'input' === t
                ? Dm.after(n)
        ...
        Xm = function(n) {
            ...
            return Nm(e, n.anchorOffset, t, n.focusOffset)
                ? B.some(Mm.range(fe.fromDom(n.anchorNode), n.anchorOffset, fe.fromDom(n.focusNode), n.focusOffset))
                : (function(n) {
                      if (0 < n.rangeCount) {
        ...
        tg = function(n) {
            return { left: n.left, top: n.top, right: n.right, bottom: n.bottom, width: E(2), height: n.height };
        },
        rg = function(n) {
            return {
                left: E(n.left),
        ...
        Ag = function(n, e) {
            var t,
                ...
                i = sf(
                    Yf.sketch({
                        dom: ms('<div aria-hidden="true" class="${prefix}-mask-tap-icon"></div>'),
                        containerBehaviours: qr([
                            ki.config({ toggleClass: Mi.resolve('mask-tap-icon-selected'), toggleOnExecute: !1 }),
                        ]),
                    })
                ),
                u = ((t = n),
                    ...
                    Yf.sketch({
                        ...
                        components: [
                            ss.sketch({
                                ...
                                buttonBehaviours: qr([
                                    ki.config({ toggleClass: Mi.resolve('mask-tap-icon-selected') }),
                                ]),
                            }),
                        ],
                    }),
        ...
        Mg = function(n) {
            ...
            var o = Eg(e, r);
            return { setReadOnly: e.setReadOnly, refreshStructure: k, enter: o.enter, exit: o.exit, destroy: k };
        },
        ...
        Bg = cs({
            ...
            factory: function(e, n, t, r) {
                var o = function(n) {
                    ...
                    i = e.shell() ? { behaviours: [Ed.config({})], components: [] } : { behaviours: [], components: n };
                return {
                    uid: e.uid(),
                    dom: e.dom(),
            ...
            factory: function(n, e, t, r) {
                return C(
                    { dom: { attributes: { role: 'toolbar' } } },
                    {
                        ...
                        components: e,
                        behaviours: C(
                            qr([uc.config({ mode: 'flow', selector: '.' + n.markers().itemClass() })]),
    ...
    function Ug() {
        var e = function(n) {
                ...
                return {
                    dom: ms('<div aria-label="' + n.label + '" class="${prefix}-toolbar-group ' + e + '"></div>'),
                    tgroupBehaviours: qr([
                        Wf(
            ...
            exhibit: function(n, e) {
                ...
                return Nr(
                    t
                        ...
                        : { classes: [e.closedClass()], styles: Et(e.dimension().property(), '0px') }
                );
            },
            events: function(t, r) {
                return br([
                    wr(J(), function(n, e) {
                        e.event().raw().propertyName === t.dimension().property() &&
                            (Kg(n, t),
                            r.isExpanded() && _i.remove(n.element(), t.dimension().property()),
                        ...
                        ns(a).fold(
                            ...
                            function(n) {
                                ei(Gn(), a, function(n) {
                                    ...
                                    (e = s),
                                        (t = Gn()),
                                        (r = { originator: E(c), kill: k, prevent: k, target: E(a) }),
                                        (i = n),
                                        (u = dv(r, (o = a))),
                                        gv(e, t, r, o, u, i);
                                });
    ...
    var Ev = function(n, e) {
            ...
            _i.setAll(t, { opacity: '0', position: 'absolute', top: '-1000px', left: '-1000px' }),
                Ye.append(n, t),
                Io(t),
                e(t),
                Qe.remove(t);
        ...
        np = function(r, o, i, u) {
            var n,
                ...
                (s = ro.get((c = r), 'style')),
                _d.register(c),
                _i.setAll(c, { position: 'absolute', height: a + 'px', width: '100%', top: t + 'px' }),
                ro.set(c, Wv, t + 'px'),
                ro.set(c, Gv, 'true'),
                ro.set(c, $v, 'top'),
                {
                ...
                v = (function(t, e) {
                    ...
                    var o = lm(r, 'touchstart', function(n) {
                        ...
                        i = function(n) {
                            ...
                            return (
                                Yl(e, [Mi.resolve('layer-editor'), Mi.resolve('unfocused-selection')]),
                                _i.setAll(e, {
                                    left: n.left() + 'px',
                                    top: n.top() + 'px',
                                    width: n.width() + 'px',
        ...
        Sp = (E(['x-small', 'small', 'medium', 'large', 'x-large']),
        function(n) {
            var e = function() {
    ...
    Ho.add('mobile', function(C) {
        return {
            ...
            renderUI: function(n) {
                var e = wp(C);
                0 == (!1 === C.settings.skin)
                    ? (C.contentCSS.push(e.content), Vo.DOM.styleSheetLoader.load(e.ui, Sp(C)))
                    : Sp(C)();
                var t,
                    r,
                    o,
                ...
                var w = n.targetNode.ownerDocument.defaultView,
                    x = vm(w, {
                        onChange: function() {
                            b.system().broadcastOn([jo.orientationChanged()], { width: pm(w) });
                        },
                        onReady: k,
                    }),
                    T = function(n, e, t, r) {
                    ...
                    S = function(n, e, t) {
                        var r = n.get(),
                            o = { readOnly: r.backToMask.concat(e.get()), main: r.backToMask.concat(t.get()) };
                        return o;
                    },
                    O = function(n, e) {
                        return (
                        ...
                        b.init({
                            editor: {
                                ...
                                onTouchContent: function() {
                                    var n,
                                        e = fe.fromDom(C.editorContainer.querySelector('.' + Mi.resolve('toolbar')));
                                    ((n = e),
