!(function() {
    ...
    var e,
        ...
        Ue = [
            ...
            { name: 'Opera', versionRegexes: [ze, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: He('opera') },
            { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: He('firefox') },
            {
                name: 'Safari',
        ...
        Ve = [
            { name: 'Windows', search: He('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
            {
                name: 'iOS',
                search: function(e) {
            ...
            { name: 'Android', search: He('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
            { name: 'OSX', search: He('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
    ...
    var Nt,
            ...
            generate: function(e) {
                ...
                k(e, function(e, c) {
                    ...
                    k(e.cells(), function(e, t) {
                        ...
                        for (
                            var r = ae.extended(e.element(), e.rowspan(), e.colspan(), c, n), o = 0;
                            o < e.colspan();
                            o++
                        )
        ...
        en = {
            ...
            remove: function(e, t) {
                var n = e.dom();
                Jt(n, t),
                    bt.has(e, 'style') && '' === bt.get(e, 'style').replace(/^\s+|\s+$/g, '') && bt.remove(e, 'style');
            },
            get: function(e, t) {
                var n = e.dom(),
    ...
    function Pn() {
        return {
            up: C({ selector: Wt.ancestor, closest: Wt.closest, predicate: Bt.ancestor, all: ot.parents }),
            down: C({ selector: St.descendants, predicate: Rt.descendants }),
            styles: C({ get: en.get, getRaw: en.getRaw, set: en.set, remove: en.remove }),
            attrs: C({
                get: bt.get,
                set: bt.set,
                remove: bt.remove,
    ...
    var In = X('left', 'right'),
            ...
            return $e.eq(a, c)
                ...
                : mr(a).bind(function(u) {
                      return mr(c).bind(function(i) {
                          if ($e.eq(u, i)) return S.some(gr({ boxes: fr(u, a, c), start: a, finish: c }));
                          if ($e.contains(u, i)) {
                              var e = 0 < (t = St.ancestors(c, 'td,th', l(u))).length ? t[t.length - 1] : c;
                              return S.some(gr({ boxes: sr(u, a, u, c, i), start: a, finish: e }));
                          }
                          if ($e.contains(i, u)) {
                              var t,
                                  n = 0 < (t = St.ancestors(a, 'td,th', l(i))).length ? t[t.length - 1] : a;
                              return S.some(gr({ boxes: sr(i, a, u, c, i), start: a, finish: n }));
                          }
                          return Qn.ancestors(a, c)
                              ...
                              .bind(function(e) {
                                  return Wt.closest(e, 'table', r).bind(function(e) {
                                      ...
                                      return S.some(gr({ boxes: sr(e, a, u, c, i), start: o, finish: n }));
                                  });
                              });
                      });
                  });
        ...
        Ar = function(n, e) {
            return Er.cata(
                ...
                function(t, e) {
                    return 0 === t.length
                        ? S.none()
                        : xr(n, Tr.firstSelectedSelector(), Tr.lastSelectedSelector()).bind(function(e) {
        ...
        Mr = {
            ...
            forMenu: function(e, t, n) {
                return { element: C(n), mergable: C(Ar(t, e)), unmergable: C(kr(n, e)), selection: C(Pr(n, e)) };
            },
            notCell: function(e) {
                return Ir(e);
            },
        ...
        Wr = function(a, e, c, l) {
            a.on('BeforeGetContent', function(n) {
                ...
                a.on('BeforeSetContent', function(u) {
                    !0 === u.selection &&
                        !0 === u.paste &&
                        S.from(a.dom.getParent(a.selection.getStart(), 'th,td')).each(function(e) {
                            var i = le.fromDom(e);
    ...
    var Lr = _r('height', function(e) {
        ...
        $r = function(e, t, n, r) {
            ...
            return (
                ...
                ('' !== s && (f.length < s.length || f.substr(d, d + s.length) !== s)) || 'table' === mt.name(t)
                    ? m
                    : ((o = t),
                      (i = m),
                      (u = n),
    ...
    var To,
                ...
                function(t) {
                    ...
                    return (
                        0 < e.length &&
                            (function(e, t) {
                                throw new Error(
                                    'All values need to be of type: ' + t + '. Keys (' + K(e).join(', ') + ') were not.'
                                );
                            })(e, i.label),
                        t
                    );
                    ...
                    return Rn.last(o)
                        .bind(function(n) {
                            ...
                            return ot.parent(n).map(function(e) {
                                return !0 === r ||
                                    ((t = e), 'li' === mt.name(t) || Bt.ancestor(t, Uo).isSome()) ||
                                    i(n) ||
                                    (Ho(e) && !$e.eq(o, e))
                                    ? []
                                    : [le.fromTag('br')];
        ...
        Ai = {
            ...
            remove: function(e, t) {
                ...
                Ei(e) ? e.dom().classList.remove(t) : Ni(e, t),
                    0 === (Ei((n = e)) ? n.dom().classList : Si(n)).length && bt.remove(n, 'class');
            },
            toggle: function(e, t) {
        ...
        Yi = function(t, e) {
            var n = A(e.selection(), function(e) {
                ...
                r = Ko(n);
            return 0 < r.length
                ? S.some(Xo({ cells: r }, { generators: e.generators, clipboard: e.clipboard }))
                : S.none();
        },
        Xi = function(e, t) {
            return t.mergable();
        ...
        ka = function(f, e) {
            var t,
                ...
                v(t) ? S.some(t.split(/[ ,]/)) : Array.isArray(t) ? S.some(t) : S.none()),
                r = function(u, a, c, l) {
                    return function(e, t) {
                        fa(e);
                        var n = l(),
        ...
        ja = {
            createStyleForm: function(n) {
                ...
                return {
                    ...
                    items: [
                        { label: 'Style', name: 'style', type: 'textbox', onchange: R(Fa, n) },
                        {
                            type: 'form',
                            padding: 0,
            ...
            if (
                    ...
                    items: [
                        {
                            ...
                            items: [
                                { label: 'Width', name: 'width', onchange: R(ja.updateStyleField, t) },
                                { label: 'Height', name: 'height', onchange: R(ja.updateStyleField, t) },
                                {
                                    label: 'Cell type',
                                    name: 'type',
                                    type: 'listbox',
                ...
                wa(t)
                    ? t.windowManager.open({
                          ...
                          bodyType: 'tabpanel',
                          data: n,
                          body: [{ title: 'General', type: 'form', items: l }, ja.createStyleForm(t)],
                          onsubmit: R(za, t, o),
                      })
                    : t.windowManager.open({ title: 'Cell properties', data: n, body: l, onsubmit: R(za, t, o) });
            }
        };
    function Ua(f, s, d, e) {
        var m = f.dom;
                ...
                (r = d[0]) &&
                    ...
                    ya(t)
                        ? t.windowManager.open({
                              ...
                              data: i,
                              bodyType: 'tabpanel',
                              body: [{ title: 'General', type: 'form', items: u }, ja.createStyleForm(t)],
                              onsubmit: R(Ua, t, d, i),
                          })
                        : t.windowManager.open({
                              title: 'Row properties',
    ...
    function Za(e, t, n, r) {
        ...
        else if (t.children) for (var o = 0; o < t.children.length; o++) Za(e, t.children[o], n, r);
    }
            ...
            xa(e) && ja.syncAdvancedStyleFields(e, n),
                ...
                e.undoManager.transact(function() {
                    t || (t = Qa(e, o.cols || 1, o.rows || 1)),
                        ...
                        !r &&
                            o.caption &&
                            (((r = i.create('caption')).innerHTML = Ga.ie ? '\xa0' : '<br data-mce-bogus="1"/>'),
        ...
        tc = function(t, e) {
            ...
            !0 === e
                ...
                xa(t)
                    ...
                    : t.windowManager.open({ title: 'Table properties', data: m, body: u, onsubmit: R(ec, t, n) });
        },
        nc = Ia.each,
                        ...
                        t(i, e).each(function(e) {
                            ...
                            (t = a),
                                ...
                                (n.width === o.width && n.height === o.height) ||
                                    (Oa(t, r.dom(), n.width, n.height), Aa(t, r.dom(), o.width, o.height)),
        ...
        vc = cc.mode({
            ...
            sink: function(e, t) {
                var n,
                    ...
                    en.setAll(o, { position: 'fixed', left: '0px', top: '0px', width: '100%', height: '100%' }),
    ...
    function Tc(e, n) {
        var r = Co.height,
            t = (function(o, t, i) {
                ...
                var c = function(e, t) {
                    ...
                    s = pc.bind(o.view(), 'mouseover', function(e) {
                        'table' === mt.name(e.target()) || Rc.closest(e.target(), 'table', f)
                            ? (u =
            ...
            o = ac.create({ beforeResize: uc(['table']), afterResize: uc(['table']), startDrag: uc([]) });
        return (
    ...
    var Nc = function(e, t) {
        ...
        Yc = {
            ...
            isWithin: function(e, t) {
                return (
                    t.compareBoundaryPoints(e.END_TO_START, e) < 1 && -1 < t.compareBoundaryPoints(e.START_TO_END, e)
                );
            },
            toString: function(e) {
                return e.toString();
        ...
        yl = function(e) {
            ...
            return Hc(t, e.anchorOffset, n, e.focusOffset)
                ? S.some(jc.range(le.fromDom(e.anchorNode), e.anchorOffset, le.fromDom(e.focusNode), e.focusOffset))
                : (function(e) {
                      if (0 < e.rangeCount) {
        ...
        return {
            ...
            situsFromPoint: function(e, t) {
                return Ol(i, e, t).map(function(e) {
                    return { start: C(Lc.on(e.start(), e.soffset())), finish: C(Lc.on(e.finish(), e.foffset())) };
                });
            },
    ...
    var Kl = function(n, e, r, t, o) {
            return $e.eq(r, t)
                ...
                : pr(r, t, e).bind(function(e) {
                      var t = e.boxes().getOr([]);
                      return 0 < t.length
                          ? (o(n, t, e.start(), e.finish()), S.some(Ll.response(S.some(Ul(r, 0, r, yn(r))), !0)))
                          : S.none();
                  });
        },
        Jl = {
        ...
        Ql = {
            nu: $l,
            moveUp: function(e, t) {
                return $l({ left: e.left(), top: e.top() - t, right: e.right(), bottom: e.bottom() - t });
            },
            ...
            translate: function(e, t, n) {
                return $l({ left: e.left() + t, top: e.top() + n, right: e.right() + t, bottom: e.bottom() + n });
            },
            toString: function(e) {
        ...
        Zl = function(e) {
            return Ql.nu({ left: e.left, top: e.top, right: e.right, bottom: e.bottom });
        },
        ef = function(e, t) {
        ...
        Hf = function(e, t, n) {
            return Ff.browser.isChrome() || Ff.browser.isSafari() || Ff.browser.isFirefox() || Ff.browser.isEdge()
                ? t.otherRetry(e, n)
                : Ff.browser.isIE()
                ? t.ieRetry(e, n)
                : S.none();
                                ...
                                var e = function(e) {
                                    return function() {
                                        return Jo(e, function(e) {
                                            ...
                                            function() {
                                                return wr(c, f.firstSelectedSelector(), f.lastSelectedSelector()).map(
                                                    function(e) {
    ...
    var ls = Ia.each,
        fs = function(t) {
            ...
            ls('inserttable tableprops deletetable | cell row column'.split(' '), function(e) {
                ...
                t.addButton('tableprops', { title: 'Table properties', onclick: e('mceTableProps'), icon: 'table' }),
        ...
        ds = function(o, n) {
            ...
            var g = { text: 'Table properties', context: 'table', onPostRender: e, onclick: m('mceTableProps') },
