    ...
    var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
                        ...
                        return (
                            v.each(d, function(e) {
                                ...
                                p.isBookmarkNode(e) && (y(n, t) || (!t && e.parentNode === o))
                                    ? (r = null)
                                    : (r || ((r = a.create('p')), e.parentNode.insertBefore(r, e), i.push(r)),
                                      r.appendChild(e));
                            }),
                            i
                        );
        ...
        V = function(e, t, n) {
            return (
                ...
                (s = t) &&
                    ...
                    ((i = t),
                    (a = n),
                    (r = e).getStyle(i, 'list-style-type', !0) === r.getStyle(a, 'list-style-type', !0)) &&
        ...
        ne = function(e, t, n, o) {
            var r,
                ...
                s = e.dom;
            if (s.isEmpty(o))
                (i = n), (a = o), (r = e).dom.$(a).empty(), te(r.dom, i, a), r.selection.setCursorLocation(a);
            else {
                var d = b(t);
        ...
        oe = function(e, t) {
            ...
            if (l) {
                ...
                if (!r && !t) return X.removeList(e), !0;
            }
            return !1;
        },
        re = function(e, t) {
