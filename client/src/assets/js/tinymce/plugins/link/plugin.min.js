!(function() {
    ...
    var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
        ...
        c = function(t) {
            if (!u.ie || 10 < u.ie) {
                ...
                if (o) {
                    ...
                    var i = o.document;
                    i.open(),
                        i.write('<meta http-equiv="refresh" content="0; url=' + l.DOM.encode(t) + '">'),
                        i.close();
                }
            }
            var r, a;
        ...
        f = function(t, e) {
            return (
                (e = e || t.selection.getNode()), m(e) ? t.dom.select('a[href]', e)[0] : t.dom.getParent(e, 'a[href]')
            );
        },
        d = function(t) {
            ...
            (u = E(v.getContent())),
                ...
                w(a.settings) &&
                    (b(a.settings) === undefined &&
                        _(a, [{ text: 'None', value: '' }, { text: 'New window', value: '_blank' }]),
