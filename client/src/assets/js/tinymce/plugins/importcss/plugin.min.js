        ...
        f = function(f, e, m) {
            ...
            function p(e, t) {
                ...
                if (
                    ((r = c),
                    (i = h.cacheSuffix),
                    'string' == typeof r && (r = r.replace('?' + i, '').replace('&' + i, '')),
                    (c = r) &&
                        m(c, t) &&
                        ((o = c),
                        (u = (s = f).settings),
                        !(l = !1 !== u.skin && (u.skin || 'lightgray')) ||
                            o !==
                                (u.skin_url ? s.documentBaseURI.toAbsolute(u.skin_url) : v.baseURL + '/skins/' + l) +
                                    '/content' +
                                    (s.inline ? '.inline' : '') +
                                    '.min.css'))
                ) {
                        ...
                        if (((f = e), (g = p), !(T(h, (m = t)) ? f in g : f in m.selectors))) {
                            ...
                            if (n) {
                                ...
                                return (
                                    ...
                                    y.extend({}, v.settings.itemDefaults, { text: n.title, format: r })
                                );
                            }
                        }
