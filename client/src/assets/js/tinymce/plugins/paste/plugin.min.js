!(function() {
    ...
    function M(e) {
        ...
        function t(t, n, r) {
            ...
            a !== s && (a < s ? i && (i = i.parent.parent) : ((o = i), (i = null))),
                i && i.name === n
                    ? i.append(t)
                    : ((o = o || i), (i = new k(n, 1)), 1 < r && i.attr('start', '' + r), t.wrap(i)),
                (t.name = 'li'),
    ...
    function O(n, r, a, i) {
        ...
        return (
            ...
            /(bold)/i.test(s['font-weight']) && (delete s['font-weight'], a.wrap(new k('b', 1))),
            /(italic)/i.test(s['font-style']) && (delete s['font-style'], a.wrap(new k('i', 1))),
    ...
    var A = {
            preProcess: function(e, t) {
                return m.shouldUseDefaultFilters(e)
                    ? (function(r, e) {
                          var t, a;
                          (t = m.getRetainStyleProps(r)) && (a = b.makeMap(t.split(/[, ]/))),
                              (e = S.filter(e, [
            ...
            var a,
                ...
                p =
                    e.settings.images_reuse_filename && r.name
                        ? ((o = e),
                          (s = r.name),
                          (l = s.match(/([\s\S]+?)\.(?:jpeg|jpg|png|gif)$/i)) ? o.dom.encode(l[1]) : null)
                        : m,
                g = new Image();
        ...
        ee = function(c, f, d) {
            ...
            function g(e, t, n, r) {
                ...
                X(e, 'text/html')
                    ? (a = e['text/html'])
                    : ((a = f.getHtml()), (r = r || y(a)), f.isDefaultContent(a) && (n = !0)),
                    (a = S.trimHtml(a)),
                    f.remove(),
                    (i = !1 === r && D(a)),
                    (a.length && !i) || (n = !0),
            ...
            c.on('keydown', function(e) {
                ...
                if (Q(e) && !e.isDefaultPrevented()) {
                    if (
                        ...
                        return;
                    if ((e.stopImmediatePropagation(), (p = new Date().getTime()), v.ie && m))
                    ...
                    (m = !1),
                        ...
                        -1 !== navigator.userAgent.indexOf('Android') && r && r.items && 0 === r.items.length)
                            ...
                            ? (s || e.preventDefault(),
                              ...
                              X(i, 'text/html')
                                  ? (e.preventDefault(), u || (u = y(i['text/html'])), g(i, s, l, u))
                                  : h.setEditorTimeout(
                                        c,
                                        function() {
                                            g(i, s, l, u);
            ...
            return {
                create: function() {
                    return (
                        ...
                        (v.ie || v.gecko) &&
                            a.setStyle(r, 'left', 'rtl' === a.getStyle(i, 'direction', !0) ? 65535 : -65535),
        ...
        le = function() {},
        ue = function(e, t, n) {
            if (((r = e), !1 !== v.iOS || r === undefined || 'function' != typeof r.setData || !0 === S.isMsEdge()))
                return !1;
            try {
        ...
        he = function(o, s, l) {
            m.shouldBlockDrop(o) &&
                ...
                o.on('dragover dragend', function(e) {
                    m.shouldPasteDataImages(o) && !1 === l.get() && (e.preventDefault(), ve(o, ge(o, e))),
    ...
    function xe(e, t) {
        ...
        return (
            (t = S.filter(t, [[r, '$1']])),
            (t = S.filter(t, [[/<br><br>/g, '<BR><BR>'], [/<br>/g, ' '], [/<BR><BR>/g, '<br>']]))
        );
    }
    function Pe(e, t, n, r) {
        if (r || n) return t;
