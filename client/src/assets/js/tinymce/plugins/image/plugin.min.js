!(function() {
    ...
    var y,
        ...
        O = function(e, t, n) {
            ...
            (n.onload = function() {
                t.width || t.height || !d(e) || e.dom.setAttribs(n, { width: n.clientWidth, height: n.clientHeight }),
                    r();
            }),
                (n.onerror = r);
        },
        ...
        ae = function(e) {
            ...
            return n
                ...
                : t &&
                  ('IMG' !== t.nodeName || t.getAttribute('data-mce-object') || t.getAttribute('data-mce-placeholder'))
                ? null
                : t;
        },
        oe = function(t, e) {
    ...
    var Ie = function(u) {
            return function(e) {
                var t = _e.get('Throbber'),
                    ...
                    a = e.control.value(),
                    o = Se(a),
                    i = Re({ url: s(u), basePath: f(u), credentials: p(u), handler: m(u) }),
                    l = function() {
                        r.hide(), Ne(o);
                    };
                return (
                ...
                items: [
                    {
                        ...
                        spacing: 10,
                        items: [
                            { text: 'Browse for an image', type: 'browsebutton', accept: Oe, onchange: Ie(e) },
                            { text: 'OR', type: 'label' },
                        ],
                    },
                    { text: 'Drop an image here', type: 'dropzone', accept: Oe, height: 100, onchange: Ie(e) },
                ],
            };
        },
        Pe = function(o) {
    ...
    function Ee(o) {
        function e(e) {
            ...
            if (
                ...
                n = o.windowManager.open({ title: 'Insert/edit image', data: r, body: we(o, t), onSubmit: Pe(Ue, o) });
            he(n);
        }
        return {
            open: function() {
            ...
            return function(e) {
                for (
                    ...
                    (t = e[r]),
                        (n = t.attr('class')) &&
                            /\bimage\b/.test(n) &&
                            (t.attr('contenteditable', o ? 'false' : null), w.each(t.getAll('figcaption'), a));
            };
        },
        De = function(e) {
