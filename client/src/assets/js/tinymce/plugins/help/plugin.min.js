!(function() {
    ...
    var e,
        ...
        w = (Array.prototype.slice, g(Array.from) && Array.from, tinymce.util.Tools.resolve('tinymce.util.I18n')),
        ...
        O = {
            shortcuts: [
                ...
                { shortcut: C + ' + K', action: 'Insert link (if link plugin activated)' },
                { shortcut: C + ' + S', action: 'Save (if save plugin activated)' },
                { shortcut: C + ' + F', action: 'Find (if searchreplace plugin activated)' },
            ],
        },
        P = function() {
        ...
        F = function(t, n) {
            return (function(e, t) {
                ...
                function(e) {
                    return H({ name: e.name, url: 'https://www.tinymce.com/docs/plugins/' + e.key });
                }
            );
        },
        M = function(t) {
            var e,
                ...
                i = a.length,
                l = a.join('');
            return '<p><b>' + w.translate(['Plugins installed ({0}):', i]) + '</b></p><ul>' + l + '</ul>';
        },
        E = function(e) {
            return {
                title: 'Plugins',
        ...
        j = function() {
            var e,
                ...
                n =
                    ...
                    ((e = I.majorVersion), (t = I.minorVersion), 0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) +
                    '</a>';
            return [
        ...
        N = function(e, t) {
            e.addButton('help', { icon: 'help', onclick: L(e, t) }),
                e.addMenuItem('help', { text: 'Help', icon: 'help', context: 'help', onclick: L(e, t) });
        };
