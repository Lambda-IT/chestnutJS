!(function() {
    ...
    var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
        ...
        v = function(e, t, n) {
            ...
            return (
                ...
                (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
                    ...
                    '%y',
                    '' + n.getYear()
                )).replace('%m', y(n.getMonth() + 1, 2))).replace('%d', y(n.getDate(), 2))).replace(
                    '%H',
                    '' + y(n.getHours(), 2)
                )).replace('%M', '' + y(n.getMinutes(), 2))).replace('%S', '' + y(n.getSeconds(), 2))).replace(
                    '%I',
                    '' + (((n.getHours() + 11) % 12) + 1)
        ...
        l = function(e) {
            e.addCommand(
                ...
                (function(l) {
                    ...
                    for (var c = new Array(arguments.length - 1), n = 1; n < arguments.length; n++)
                        c[n - 1] = arguments[n];
                    return function() {
        ...
        H = function(e) {
            e.addButton('template', { title: 'Insert template', onclick: n(e.settings, D(e)) }),
