                    ...
                    : ((i = e),
                      ...
                      p({
                          ...
                          start: function(e, t) {
                              ...
                              'source' === e &&
                                  (a.source1 ? a.source2 || (a.source2 = t.map.src) : (a.source1 = t.map.src)),
        ...
        F = function(e, t) {
            ...
            for (r in t)
                if (((a = '' + t[r]), e.map[r]))
                    for (i = e.length; i--; )
                        (o = e[i]).name === r &&
                            (a ? ((e.map[r] = a), (o.value = a)) : (delete e.map[r], e.splice(i, 1)));
                                  ...
                                  if (o)
                                      switch (e) {
                                          ...
                                          case 'source':
                                              if (
                                                  ++s <= 2 &&
                                                  (F(t, { src: a['source' + s], type: a['source' + s + 'mime'] }),
                                                  !a['source' + s])
                                              )
                                                  return;
                                              break;
                                  ...
                                  if ('video' === e && o)
                                      for (var t = 1; t <= 2; t++)
                                          if (a['source' + t]) {
                                              ...
                                              (r.map = {}),
                                                  s < t &&
                                                      (F(r, { src: a['source' + t], type: a['source' + t + 'mime'] }),
                                                      c.start('source', r, !0));
                                          }
                        ...
                        start: function(e, t, r) {
                            if (((o = !0), 'script' !== e && 'noscript' !== e)) {
                                for (var i = 0; i < t.length; i++) {
                                    ...
                                    'style' === t[i].name &&
                                        (t[i].value = a.dom.serializeStyle(a.dom.parseStyle(t[i].value), e));
                                }
                                n.start(e, t, r), (o = !1);
                            }
                        },
            ...
            t.on('click keyup', function() {
                ...
                t.on('objectResized', function(e) {
                    ...
                    r.getAttribute('data-mce-object') &&
                        ...
                        ((t = unescape(t)),
                        r.setAttribute('data-mce-html', escape(A(t, { width: e.width, height: e.height }))));
                });
        },
        oe = function(e) {
            e.addButton('media', {
