...
!(function() {
    ...
    (d = /Android/.test(ce)),
        (a =
            (a = !(i = /WebKit/.test(ce)) && /MSIE/gi.test(ce) && /Explorer/gi.test(se.appName)) &&
            /MSIE (\w+)\./.exec(ce)[1]),
        (u =
            -1 !== ce.indexOf('Trident/') && (-1 !== ce.indexOf('rv:') || -1 !== se.appName.indexOf('Netscape')) && 11),
        ...
        He = function(e, t, n) {
            ...
            if (n.domLoaded) t(o);
                ...
                !r.addEventListener || (Re.ie && Re.ie < 11)
                    ? (ze(r, 'readystatechange', u), r.documentElement.doScroll && e.self === e.top && s())
                    : i()
                    ? a()
                        ...
                        if (((s = y[r]), t)) {
                            for (i = (t = t.split(' ')).length; i--; )
                                if ((o = s[(u = t[i])])) {
                                    ...
                                    (n && 0 !== o.length) ||
                                        (delete s[u], Ve(e, o.fakeName || u, o.nativeHandler, o.capture));
                                }
                        } else {
    ...
    ((ge = Tt.selectors = {
        ...
        filter: {
            ...
            PSEUDO: function(e, i) {
                var t,
                    a = ge.pseudos[e] || ge.setFilters[e.toLowerCase()] || Tt.error('unsupported pseudo: ' + e);
                return a[$e]
                    ? a(i)
                    : 1 < a.length
                    ? ((t = [e, e, '', i]),
            ...
            if ((t = ge.relative[e[u].type])) l = [It(Mt(l), t)];
                ...
                if ((t = ge.filter[e[u].type].apply(null, e[u].matches))[$e]) {
                    ...
                    return Ut(
                        1 < u && Mt(l),
                        1 < u &&
                            Lt(e.slice(0, u - 1).concat({ value: ' ' === e[u - 2].type ? '*' : '' })).replace(ft, '$1'),
                        t,
                        u < n && zt(e.slice(u, n)),
                        n < o && zt((e = e.slice(n))),
                        n < o && Lt(e)
    ...
    (Pt.prototype = ge.filters = ge.pseudos),
        ...
        (ve = Tt.tokenize = function(e, t) {
            ...
            for (a = e, u = [], s = ge.preFilter; a; ) {
                ...
                (n = !1),
                (r = mt.exec(a)) &&
                    ((n = r.shift()), o.push({ value: n, type: r[0].replace(ft, ' ') }), (a = a.slice(n.length))),
                ge.filter))
                    !(r = vt[i].exec(a)) ||
                        (s[i] && !(r = s[i](r))) ||
        ...
        (ye = Tt.select = function(e, t, n, r) {
            ...
            if (((n = n || []), 1 === l.length)) {
                ...
                for (o = vt.needsContext.test(e) ? 0 : i.length; o-- && ((a = i[o]), !ge.relative[(u = a.type)]); )
                    if (
                        (s = ge.find[u]) &&
                        (r = s(a.matches[0].replace(Et, St), (wt.test(i[0].type) && Ot(t.parentNode)) || t))
                    ) {
    ...
    var Vt = Array.isArray,
        ...
        Yt = {
            ...
            makeMap: function(e, t, n) {
                var r;
                for (
                    t = t || ',', 'string' == typeof (e = e || []) && (e = e.split(t)), n = n || {}, r = e.length;
                    r--;
        ...
        on = function(e, t) {
            var n, r, o;
            for (
                o = (t = t || Gt).createElement('div'), n = t.createDocumentFragment(), o.innerHTML = e;
                (r = o.firstChild);
    ...
    (pn.fn = pn.prototype = {
        ...
        add: function(e, t) {
            ...
            if (!1 !== t)
                for (n = pn.unique(o.toArray().concat(pn.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++)
                    o[r] = n[r];
            ...
            if (!Do.isElement(t) || !Bo(t)) {
                ...
                if (!1 === Do.isDocument(t)) {
                    if (Do.isText(t) && 0 < t.nodeValue.length) {
                        ...
                        Do.isElement(t) &&
                        (1 === (r = t.childNodes).length && Bo(r[0]) && t.parentNode.insertBefore(r[0], t),
        ...
        ei = function(e) {
            var u,
                ...
                a = function(e, t, n) {
                    ...
                    for (t = t || '', 'string' == typeof (n = n || []) && (n = Zo(n)), r = (e = Zo(e)).length; r--; )
                        (i = { attributes: a((o = Zo([u, t].join(' ')))), attributesOrder: o, children: a(n, Ko) }),
                            (s[e[r]] = i);
                },
                c = function(e, t) {
                    var n, r, o, i;
            ...
            v = function(e, t, n) {
                ...
                return (
                    r
                        ...
                        : (r = Wo[e]) || ((r = Xo(t, ' ', Xo(t.toUpperCase(), ' '))), (r = Go(r, n)), (Wo[e] = r)),
                    r
                );
            };
        (n = ei((i = i || {}).schema)),
        ...
        var r = {},
            ...
            v = function(e, t, n) {
                var r,
                    ...
                    i = h(e);
                return (
                    i.length && (o = (r = s[t]) && r.get ? r.get(i, t) : i.attr(t)), void 0 === o && (o = n || ''), o
                );
            },
            b = function(e) {
                var t = p(e);
    ...
    var Yi,
        ...
        yu = function(e) {
            var t, n, r, o, i, a, u, s;
            return (
                (t = 0 < (n = e.getClientRects()).length ? Xa(n[0]) : Xa(e.getBoundingClientRect())),
                !hu(e) && fu(e) && bu(t)
                    ? ((i = (r = e).ownerDocument),
                      (a = gu(i)),
        ...
        xu = function(e) {
            var t,
                ...
                i = function(e, t) {
                    ...
                    if (t < e.data.length) {
                        ...
                        if (nu(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !vu(n)))
                            return o(Cu(yu(n), !1)), r;
                    }
                    0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), vu(n) || o(Cu(yu(n), !1))),
                        t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), vu(n) || o(Cu(yu(n), !0)));
                };
            ...
            if (ou(e.container()))
                if (e.isAtEnd())
                    ...
                    if (((n = mu(e.container(), e.offset())), lu(n) && i(n, 0), su(n) && e.isAtEnd()))
                        return o(Cu(yu(n), !1)), r;
    ...
    var Nu,
        ...
        qu = function(e, t, n) {
            ...
            var a,
                ...
                f,
                d,
                m = Vu((a = i).startContainer, a.startOffset) || Vu(a.endContainer, a.endOffset);
            return m
        ...
        ts = function(e, t) {
            var n,
                ...
                o,
                i = t.container(),
                a = ((n = ne(i.childNodes)), (r = e), (o = L(n, r)), -1 === o ? A.none() : A.some(o))
                    .map(function(e) {
        ...
        ns = function(e, t) {
            return Gu(e) && t.container() === e
                ? ((r = t),
                  ...
                  0 < (a = o.text + i.text).length ? (Qu(n, a), Su(n, r.offset() - o.count)) : r)
                : es(e, t);
            var n, r, o, i, a;
        },
        rs = function(e) {
        ...
        os = {
            removeAndReposition: function(e, t) {
                return Su.isTextPosition(t)
                    ? ns(e, t)
                    : ((n = e), (r = t).container() === n.parentNode ? ts(n, r) : es(n, r));
                var n, r;
            },
            remove: rs,
        },
    ...
    var fs,
        ...
        ws = function(e, t, n) {
            ...
            if (t.isEqual(Su.after(n)) && n.lastChild) {
                if (((u = Su.after(n.lastChild)), zc(e) && vs(n.lastChild) && ps(n.lastChild)))
            ...
            if (gs(f)) {
                ...
                if (Uc(e) && d < f.childNodes.length && ((o = Cs(f, d)), vs(o)))
                    return hs(o) && n.lastChild === o
                        ...
                        : ((s = o),
                          (c = n),
                          Do.isBr(s) && (l = ws(1, Su.after(s), c)) && !jc(Su.before(s), Su.before(l), c)
                              ? ws(e, Su.after(o), n)
                              : !bs(o) && (i = qc(o, e, ys, o))
                              ? gs(i)
                                  ? Su(i, 0)
    ...
    var Es,
        ...
        Rs = function(e, t, n, r) {
            for (
                ...
                f && ((s = l), (c = f), (o = t === Nu.Forwards ? s.next(c) : s.prev(c)));

            ) {
                if (Do.isBr(o.getNode(!1)))
                    return t === Nu.Forwards
                        ? { positions: _s(t, d).concat([o]), breakType: fs.Br, breakAt: A.some(o) }
                ...
                if (o.isVisible()) {
                    if (e(f, o)) {
                        ...
                        (a = f),
                        (u = o),
                        Do.isBr(u.getNode(i === Nu.Forwards)) ? fs.Br : !1 === jc(a, u) ? fs.Block : fs.Wrap);
            ...
            var i,
                ...
                l = U(
                    ...
                    G(c, function(e) {
                        var t,
                            n,
                            r = ((t = Xa(e.getBoundingClientRect())),
                            (n = -1),
                            {
                                left: t.left - n,
                                top: t.top - n,
        ...
        yc = function(e, t, n) {
            ...
            return ((a = u).breakType === fs.Wrap && 0 === a.positions.length) ||
                (!Do.isBr(n.getNode()) && (i = u).breakType === fs.Br && 1 === i.positions.length)
                ? ((r = e),
                  (o = t),
                  !u.breakAt
                      .map(function(e) {
                ...
                show: function(t, e) {
                    ...
                    if (!u(e))
                        return (
                            ...
                            Ac(s.nextSibling) ? (r.setStart(s, 0), r.setEnd(s, 0)) : (r.setStart(s, 1), r.setEnd(s, 1)),
                            r
                        );
        ...
        Gc = function(e, t, n) {
            ...
            if (((o = n.startContainer), (i = n.startOffset), Ta(o))) {
                if (
                    (Mc(o) || (o = o.parentNode),
                    'before' === (a = o.getAttribute('data-mce-caret')) && ((r = o.nextSibling), Dc(r)))
                )
                    return Xc(r);
        ...
        sl = function(e, t, n) {
            return e
                ? !ul(t, n) && ((r = t), !(!Su.isTextPosition(r) && Do.isBr(r.getNode()))) && al(t) && il(n)
                : !ul(n, t) && il(t) && al(n);
            var r;
        },
        cl = function(e, t, n) {
        ...
        ll = function(e, t) {
            ...
            return Do.isText(u)
                ...
                : u
                ? ja(u)
                    ? A.some(e ? Su.before(u) : ((a = u), Do.isBr(a) ? Su.before(a) : Su.after(a)))
                    : ((r = t), (o = u), (i = (n = e) ? Su.before(o) : Su.after(o)), cl(n, r, i))
                : A.none();
        },
        fl = {
            fromPosition: cl,
        ...
        bl = function(e, t) {
            ...
            if (t) {
                if (((v = t), Yt.isArray(v.start)))
                    return (
                        (p = t), (h = (g = b).createRng()), pl(g, !0, p, h) && pl(g, !1, p, h) ? A.some(h) : A.none()
                    );
        ...
        Sl = {
            ...
            moveStart: function(e, t, n) {
                var r,
                    ...
                    u = n.startContainer;
                if (
                    (n.startContainer !== n.endContainer || !wl(n.startContainer.childNodes[n.startOffset])) &&
                    1 === u.nodeType
                )
                    for (
                        a < (i = u.childNodes).length
                            ? (r = new oo((u = i[a]), e.getParent(u, e.isBlock)))
                            : (r = new oo((u = i[i.length - 1]), e.getParent(u, e.isBlock))).next(!0),
                            o = r.current();
                        o;
                        o = r.next()
                    )
        ...
        Pl = function(e, t, n, r, o) {
            var i, a, u, s;
            for (
                3 === r.nodeType && 0 === r.nodeValue.length && r[o] && (r = r[o]), i = kl(e, r), a = 0;
                a < i.length;
                a++
            )
        ...
        Ml = function(e, t, n, r) {
            ...
            return (
                ...
                t.collapsed &&
                    ((o = Ol(c, e.getBody(), i, a, !0, r)) && ((i = o.container), (a = o.offset)),
                    (o = Ol(c, e.getBody(), u, s, !1, r)) && ((u = o.container), (s = o.offset))),
                n[0].inline &&
                    (u = r
                        ? u
                        : (function(e, t) {
                ...
                (n[0].inline || n[0].block_expand) &&
                    ((n[0].inline && 3 === i.nodeType && 0 !== a) || (i = Il(c, n, i, a, u, s, !0)),
                    (n[0].inline && 3 === u.nodeType && s !== u.nodeValue.length) || (u = Il(c, n, i, a, u, s, !1))),
                n[0].selector &&
                    !1 !== n[0].expand &&
                    !n[0].inline &&
                    ((i = Pl(c, n, t, i, 'previousSibling')), (u = Pl(c, n, t, u, 'nextSibling'))),
    ...
    var Kl = function(e) {
        ...
        Xl = function(e) {
            return (
                e && e.firstChild && e.firstChild === e.lastChild && ('\xa0' === (t = e.firstChild).data || Do.isBr(t))
            );
            var t;
        },
        Yl = function(e) {
        ...
        ef = function(e, o, i, t) {
            ...
            return k(1)
                ? Ql(E, S, T)
                : k(2)
                ? ((f = E), (d = S), (m = T), o.insertAfter(d.reverse(), f), Jl(d[0], m))
                : ((p = S),
                  (h = T),
                  (v = g = E),
                  (y = (b = i).cloneRange()),
    ...
    var ff = function(a) {
        ...
        gf = function(o, e, t) {
            ...
            if (
                    ...
                    h.isCollapsed() ||
                        ...
                        3 === C.nodeType &&
                            ...
                            ('\xa0' === C.data[x]
                                ...
                                : '\xa0' === C.data[x - 1] &&
                                  (C.deleteData(x - 1, 1), /[\u00a0| ]$/.test(e) || (e = ' ' + e))));
                var E,
                    S,
                    T,
                    k = { context: (i = h.getNode()).nodeName.toLowerCase(), data: t.data, insert: !0 };
                if (((u = n.parse(e, k)), !0 === t.paste && Zl(o.schema, u) && tf(v, i)))
                    return (l = ef(r, v, o.selection.getRng(), u)), o.selection.setRng(l), void o.fire('SetContent', s);
                if (
                    ((function(e) {
                ...
                if ((o._selectionOverrides.showBlockCaretContainer(i), k.invalid)) {
                    for (
                        h.setContent(m), i = h.getNode(), a = o.getBody(), 9 === i.nodeType ? (i = f = a) : (f = i);
                        f !== a;
        ...
        Rf = {
            ...
            findRootInline: function(e, t, n) {
                var r,
                    o,
                    i,
                    a = ((r = e), (o = t), (i = n), U(pi.DOM.getParents(i.container(), '*', o), r));
        ...
        Lf = function(e, t) {
            return (
                Do.isText(t) &&
                /^[ \t\r\n]*$/.test(t.data) &&
                !1 === ((n = e), (r = t), (o = er.fromDom(n)), (i = er.fromDom(r)), Pf(i, 'pre,code', b(Fr.eq, o)))
            );
            var n, r, o, i;
        },
        If = function(e, t) {
            return (
                (ja(t) && !1 === Lf(e, t)) ||
                ((n = t), Do.isElement(n) && 'A' === n.nodeName && n.hasAttribute('name')) ||
                Mf(t)
            );
            var n;
        },
        ...
        ud = function(e) {
            ...
            return ad(i, a)
                ...
                : ((n = i),
                  (r = e.selection),
                  (o = r.getRng()),
                  ru([Df(n, er.fromDom(o.startContainer)), Df(n, er.fromDom(o.endContainer))], function(e, t) {
                      return (
                          !1 === Fr.eq(e, t) &&
                          (o.deleteContents(),
        ...
        gd = function(e, t) {
            return (
                ...
                (o = (n = t).container()),
                (i = n.offset()),
                !1 === Su.isTextPosition(n) && o === r.parentNode && i > Su.before(r).offset()
        ...
        pd = function(e) {
            return ja(e.previousSibling)
                ? A.some(((t = e.previousSibling), Do.isText(t) ? Su(t, t.data.length) : Su.after(t)))
                : e.previousSibling
            ...
            return e
                ? (function(e) {
                      if (Ad(e.previousSibling))
                          return Rd(e.previousSibling) || e.previousSibling.appendData(wa), e.previousSibling;
                ...
                : (function(e) {
                      ...
                      var t = Dd(e);
                      return (
                          e.nextSibling ? e.parentNode.insertBefore(t, e.nextSibling) : e.parentNode.appendChild(t), t
                      );
                  })(t);
        },
        Od = b(Bd, !0),
                    ...
                    return s.isSome() && e.isSome()
                        ? Rf.findRootInline(u, a, o)
                              .map(function(e) {
                                  return (
                                      (o = e),
                                      !!ru([fl.firstPositionIn(o), fl.lastPositionIn(o)], function(e, t) {
                                          var n = Rf.normalizePosition(!0, e),
                                              r = Rf.normalizePosition(!1, t);
                                          return fl
                                              .nextPosition(o, n)
        ...
        Dm = function(n) {
            return ((r = n),
            ru([Rm(r.cells(), r.rng().start()), Rm(r.cells(), r.rng().end())], function(e, t) {
        ...
        fg = function(e, t, n, r, o) {
            ...
            if (((u = e.getParent(o.parentNode, e.isBlock) || f), r && Do.isBr(o) && t && e.isEmpty(u)))
                return A.some(wu(o.parentNode, e.nodeIndex(o)));
            for (i = new oo(o, u); (s = i[r ? 'prev' : 'next']()); ) {
                if ('false' === e.getContentEditableParent(s) || ((l = f), Aa((c = s)) && !1 === ug(c, l, Ku)))
                    return A.none();
                if (Do.isText(s) && 0 < s.nodeValue.length)
                    return !1 === sg(s, f, 'A') ? A.some(wu(s, r ? s.nodeValue.length : 0)) : A.none();
    ...
    var Gg = Yt.makeMap(
        ...
        Jg = function(a) {
            ...
            var r = function(e, t, n, r) {
                    var o, i, a;
                    if ((!1 === t && (t = f), t))
                        for (t = { func: t }, r && Yt.extend(t, r), a = (i = e.toLowerCase().split(' ')).length; a--; )
    ...
    var Qg,
        ...
        fp = function(e, t) {
            return 'selectionchange' === t
                ...
                ? (e.eventRoot || (e.eventRoot = lp.select(e.settings.event_root)[0]), e.eventRoot)
                : e.getBody();
        },
        dp = function(e, t, n) {
            var r;
            ...
            toggleNativeEvent: function(e, t) {
                ...
                'focus' !== e &&
                    ...
                    (t
                        ...
                        : n.initialized && (n.dom.unbind(fp(n, e), e, n.delegates[e]), delete n.delegates[e]));
            },
    ...
    function Cp(i) {
        var a = {},
            ...
            u = function(e) {
                ...
                for (n in (hp(vp(e, '+'), function(e) {
                    e in yp
                        ...
                        : ((r.charCode = e.charCodeAt(0)), (r.keyCode = bp[e] || e.toUpperCase().charCodeAt(0)));
                }),
                (t = [r.keyCode]),
                yp))
                    r[n] ? t.push(n) : (r[n] = !1);
            ...
            s = function(e, t, n, r) {
                var o;
                return (
                    ((o = Yt.map(vp(e, '>'), u))[o.length - 1] = Yt.extend(o[o.length - 1], {
                        func: n,
                        scope: r || i,
                    })),
    ...
    var xp = function(e) {
        ...
        Ep = function(t, e) {
            return ((n = e), n.collapsed ? A.from(eu(n.startContainer, n.startOffset)).map(er.fromDom) : A.none()).bind(
                function(e) {
    ...
    function mh(u) {
        var n,
            ...
            C = function(n) {
                return (
                    a || (a = Zp(d, { url: dc(u), basePath: mc(u), credentials: gc(u), handler: pc(u) })),
                    N().then(
                        g(function(r) {
                            var e;
                            return (
                                ...
                                a.upload(e, b).then(
                                    g(function(e) {
                                        var t = $(e, function(e, t) {
                                            var n = r[t].image;
                                            return (
                                                e.status && fc(u) ? y(n, e.url) : e.error && Kp(u, e.error),
    ...
    var Mh = function(o, i, a, e, u, t) {
        ...
        Kh = function(e, o) {
            return jt.reduce(e, function(e, t) {
                ...
                return (
                    ...
                    Wh(o, t) ? t : Wh(o, e) ? e : r === n && qh(t.node) ? t : r < n ? t : e
                );
            });
        },
        Xh = function(e, t, n, r) {
        ...
        Yh = function(e, t, n) {
            var r,
                ...
                c,
                l,
                f = Ih(((o = e), jt.filter(jt.toArray(o.getElementsByTagName('*')), Dc))),
    ...
    var uv = av,
        ...
        Av = function(e, t, n) {
            'fragmented' === t.type ? vv(t.fragments, e.getBody()) : e.setContent(t.content, { format: 'raw' }),
        ...
        return (
            ...
            (o = {
                ...
                add: function(e, t) {
                    ...
                    if (
                        ((r = l[c]),
                        u.fire('BeforeAddUndo', { level: e, lastLevel: r, originalEvent: t }).isDefaultPrevented())
                    )
                        return null;
                ...
                undo: function() {
                    ...
                    return (
                        ...
                        0 < c && ((e = l[--c]), Av(u, e, !0), d(!0), u.fire('undo', { level: e })),
                        e
                    );
                },
                redo: function() {
    ...
    var Dv,
        ...
        Iv = function(e, t, n) {
            return (
                !!Ov(t, n.inline) || !!Ov(t, n.block) || (n.selector ? 1 === t.nodeType && e.is(t, n.selector) : void 0)
            );
        },
                ...
                if ('undefined' == typeof c.length) {
                    for (a in c)
                        if (c.hasOwnProperty(a)) {
                            if (
                                ((u = 'attributes' === r ? e.getAttrib(t, a) : Sl.getStyle(e, t, a)),
                                o && !u && !n.exact)
                            )
                                return;
                            if ((!o || n.exact) && !Ov(u, Sl.normalizeStyleValue(e, Sl.replaceVars(c[a], i), a)))
                                return;
                        }
                } else
        ...
        Fv = function(e, t, n, r, o) {
            ...
            if (c && t)
                for (a = 0; a < c.length; a++)
                    if (
                        ((i = c[a]), Iv(e.dom, t, i) && Mv(l, t, i, 'attributes', o, r) && Mv(l, t, i, 'styles', o, r))
                    ) {
        ...
        Uv = {
            ...
            match: function(e, t, n, r) {
                ...
                return r
                    ? Lv(e, r, t, n)
                    : ((r = e.selection.getNode()),
                      !!Lv(e, r, t, n) || !((o = e.selection.getStart()) === r || !Lv(e, o, t, n)));
            },
            ...
            return (
                t === r && Do.isText(t)
                    ? 0 < n &&
                      ...
                      n < o ? ((t = r = zv(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
                    : (Do.isText(t) && 0 < n && n < t.nodeValue.length && ((t = zv(t, n)), (n = 0)),
                      Do.isText(r) &&
                          0 < o &&
        ...
        Wv = function(e) {
            ...
            return (
                hr.setAll(t, { id: Hv, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
        ...
        Xv = function(e, t, n, r, o) {
            if (r) Kv(t, n, r, o);
            else if (!(r = Xu(e, n.getStart()))) for (; (r = t.get(Hv)); ) Kv(t, n, r, !1);
        },
        Yv = function(e, t, n) {
            var r = e.dom,
            ...
            o && r.isEmpty(o)
                ...
                : (of(er.fromDom(n)), r.isEmpty(n) ? n.parentNode.replaceChild(t, n) : r.insertAfter(t, n));
        },
        Gv = function(e, t) {
        ...
        Qv = function(e) {
            ...
            e.on('mouseup keydown', function(e) {
                ...
                (t = u),
                    ...
                    (o = e.keyCode),
                    Xv(t, n, r, null, !1),
                    8 === o && r.isCollapsed() && r.getStart().innerHTML === qv && Xv(t, n, r, Xu(t, r.getStart())),
    ...
    var rb = function(e, t) {
        ...
        sb = function(e, t, n) {
            ...
            return (
                ...
                Do.isElement(r) && ((i = r.childNodes.length - 1), !n && o && o--, (r = r.childNodes[i < o ? i : o])),
                ...
                for (
                    ib(n.styles, function(e, t) {
                        (e = Sl.normalizeStyleValue(y, Sl.replaceVars(e, r), t)),
                            ...
                            (n.remove_similar || !i || ab(Sl.getStyle(y, i, t), e)) && y.setStyle(o, t, ''),
                            (u = 1);
                    }),
                        u &&
                            '' === y.getAttrib(o, 'style') &&
                            ...
                            ((g.list_block && ab(m, g.list_block)) ||
                                ib(Yt.grep(m.childNodes), function(e) {
                                    Sl.isValid(d, b, e.nodeName.toLowerCase())
                                        ? p
                                            ? p.appendChild(e)
                                            : ((p = cb(v, e, b)), v.setAttribs(p, d.settings.forced_root_block_attrs))
                                        : (p = 0);
                                }))
                          : v.isBlock(m) &&
                            !v.isBlock(h) &&
                            (lb(v, m, !1) || lb(v, m.firstChild, !0, 1) || m.insertBefore(v.create('br'), m.firstChild),
                            lb(v, m, !0) || lb(v, m.lastChild, !1, 1) || m.appendChild(v.create('br')))),
                    ...
                    var n,
                        ...
                        ib(Sl.getParents(n.dom, t.parentNode).reverse(), function(e) {
                            ...
                            a ||
                                '_start' === e.id ||
                                '_end' === e.id ||
                                ((t = Uv.matchNode(n, e, r, o, i)) && !1 !== t.split && (a = e));
                        }),
                        a);
                        ...
                        if (((e = Vv(e)), (t = sb(s, e, !0)) !== (n = sb(s, e)))) {
                            if (
                                ...
                                r &&
                                    ...
                                    n.firstChild &&
                                    (n = n.firstChild || n),
                                u.isChildOf(t, n) && t !== n && !u.isBlock(n) && !ub(t) && !ub(n))
                            ) {
                            ...
                            (t = cb(u, t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                                (n = cb(u, n, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
                                i(t),
                                i(n),
                                (t = p(!0)),
                                (n = p());
            ...
            if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), o(n)) : o(e);
                ...
                r.isCollapsed() && m.inline && !u.select('td[data-mce-selected],th[data-mce-selected]').length
                    ...
                    : ((t = $u.getPersistentBookmark(s.selection, !0)),
                      o(r.getRng()),
                      r.moveToBookmark(t),
                      m.inline && Uv.match(s, c, l, r.getStart()) && Sl.moveStart(u, r, r.getRng()),
                      s.nodeChanged());
            else {
                e = r.getNode();
        ...
        Sb = function(e, t, n, r) {
            t.styles &&
                ...
                bb(r, yb(e, 'fontSize'), Cb(e, 'backgroundColor', Sl.replaceVars(t.styles.backgroundColor, n)));
        },
        Tb = function(e, t, n, r) {
        ...
        kb = function(e, t, n, r) {
            r &&
                !1 !== t.merge_siblings &&
                ((r = vb(e, Sl.getNonWhiteSpaceSibling(r), r)), (r = vb(e, r, Sl.getNonWhiteSpaceSibling(r, !0))));
        },
                    ...
                    return (
                        ...
                        (_b(e, function(e) {
                            if (!('collapsed' in e && e.collapsed !== o))
                                return i.is(t, e.selector) && !Ku(t) ? (y(t, e), !(n = !0)) : void 0;
                        }),
                        n)
                    );
                },
                                ...
                                u = function(e) {
                                    ...
                                    if (b.wrapper && Uv.matchNode(g, e, p, h)) a = 0;
                                        ...
                                        (b.inline && s.isBlock(e))
                                            ? ((a = 0), _b(Yt.grep(e.childNodes), u), r && (m = o), (a = 0))
                                ...
                                a = function(e) {
                                    ...
                                    return (
                                        _b(e.childNodes, function(e) {
                                            if ((t = e) && 1 === t.nodeType && !xl(t) && !Ku(t) && !Do.isBogus(t))
                                                return (n = e), !1;
                                            var t;
                                        }),
                                        n
            ...
            if ('false' !== i.getContentEditable(n.getNode())) {
                if (b) {
                    if (r)
                        r.nodeType
                            ? C(v, r) ||
                              ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Ml(g, t, v), 0, !0))
                            : a(i, r, 0, !0);
        ...
        Mb = function(e, t) {
            var n,
                ...
                p = function(n, e, t) {
                    ...
                    if (
                        ...
                        (i =
                            !(!(l = c && c.parentsRequired) || !l.length) && (u && -1 !== Yt.inArray(l, u) ? u : l[0])))
                    )
            ...
            return e && e.length
                ? ((o = e[0]), (n = g(o)), (r = Ib.create('div')).appendChild(p(n, e.slice(1), o.siblings)), r)
                : '';
        },
        Fb = function(e) {
            var t,
                    ...
                    (t = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, function(e, t, n, r, o) {
                        switch (t) {
                            ...
                            case '.':
                                ...
                                break;
                            case ':':
                                -1 !== Yt.inArray('checked disabled enabled read-only required'.split(' '), n) &&
                                    (a.attrs[n] = n);
                        }
                        if ('[' === r) {
                            var i = o.match(/([\w\-]+)(?:\=\"([^\"]+))?/);
                      ...
                      if (
                          !(
                              ('background-color' === e &&
                                  ...
                                  ((t = Ib.getStyle(n.getBody(), e, !0)), '#ffffff' === Ib.toHex(t).toLowerCase())) ||
    ...
    var jb,
            ...
            register: function(t, s, c) {
                t.addAttributeFilter('data-mce-tabindex', function(e, t) {
                    ...
                    t.addAttributeFilter('src,href,style', function(e, t) {
                        for (
                            var n, r, o = e.length, i = 'data-mce-' + t, a = s.url_converter, u = s.url_converter_scope;
                            o--;
        ...
        Gb = function(e, t) {
            var n,
                r = oi();
            t.convert_fonts_to_spans && Yb(e, r, Yt.explode(t.font_size_legacy_values)),
                (n = r),
            ...
            e = {
                ...
                parse: function(e, a) {
                    ...
                    (a = a || {}),
                        (R = {}),
                        (D = {}),
                        (l = fy(sy('script,style,head,html,body,title,meta,param'), k.getBlockElements()));
                    ...
                    t = uv(
                        {
                            ...
                            text: function(e, t) {
                                var n;
                                f || ((e = e.replace(x, ' ')), ay(d.lastChild, l) && (e = e.replace(y, ''))),
                            ...
                            start: function(e, t, n) {
                                ...
                                if ((n = h ? k.getElementRule(e) : {})) {
                                    ...
                                    if (
                                        (f && b[e] && (f = !1),
                                        n.removeEmpty && iy(k, g, b, d) && !d.attributes.map.name && !d.attr('id'))
                                    )
                                        return (
                                              ...
                                              if (m[n.name] && 'li' === n.parent.name) {
                                                  ...
                                                  if (r && 1 < o.length) {
                                                      ...
                                                      iy(k, l, f, i)
                                                          ...
                                                          (r = o[0]),
                                                          (iy(k, l, f, r) || oy(r, 'br')) && r.empty().remove();
                                                  } else if (n.parent) {
                                                      if ('li' === n.name) {
                        ...
                        v &&
                            ...
                            (function() {
                                var e,
                                    ...
                                    r = function(e) {
                                        e &&
                                            ((n = e.firstChild) && 3 === n.type && (n.value = n.value.replace(y, '')),
    ...
    var yy = by,
                ...
                O = function(e) {
                    ...
                    (t = e.screenX - d),
                        ...
                        (R(u) && !1 !== a.settings.resize_img_proportional
                            ...
                            (k(t) > k(n) ? ((C = A(y * b)), (y = A(C / b))) : ((y = A(C / b)), (C = A(y * b)))),
        ...
        By = function(e, t) {
            for (var n = e.rows(), r = 0; r < n.length; r++)
                for (var o = n[r].cells(), i = 0; i < o.length; i++) if (Fr.eq(o[i], t)) return A.some(_y(i, r));
            return A.none();
        },
        ...
        Hy = function(e, t) {
            ...
            r.cloneContents
                ? (n = t.contextual ? qy(er.fromDom(e.getBody()), a).dom() : r.cloneContents()) && o.appendChild(n)
            ...
            var n,
                ...
                m = function() {
                    ...
                    try {
                        (e = d()) &&
                            (t =
                                0 < e.rangeCount ? e.getRangeAt(0) : e.createRange ? e.createRange() : r.createRange());
                    } catch (a) {}
                    return (
                        ...
                        l &&
                            f &&
                            (0 === o(t.START_TO_START, t, l) && 0 === o(t.END_TO_END, t, l) ? (t = f) : (f = l = null)),
                        t
                    );
                },
                i = function(e, t) {
                        ...
                        return (
                            ...
                            (t = m())
                                ? ((r = t.startContainer),
                                  ...
                                  3 === r.nodeType &&
                                      3 === o.nodeType &&
                                      ((r = r.length === i ? Xy(r.nextSibling, !0) : r.parentNode),
                    ...
                    getSelectedBlocks: function(e, t) {
                        return (function(e, t, n, r) {
                            ...
                            if (
                                ...
                                for (var u = new oo((o = n), i); (o = u.next()) && o !== r; ) e.isBlock(o) && a.push(o);
                ...
                : ((u = Ta(r.startContainer)),
                  f((i = el(e, t.getBody(), r)))
                      ...
                      ? f(i)
                          ...
                          : f((a = n(i))) && ((!(c = jc((s = i), a)) && Do.isBr(s.getNode())) || c)
        ...
        iC = function(e, t, n, r) {
            ...
            if (((c = s.left), (u = Kh(a, c)) && Zy(u.node)))
                return (l = Math.abs(c - u.left)), (f = Math.abs(c - u.right)), us(e, t, u.node, l < f, !0);
            if (d) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ...
                    fC(
                        [
                            ...
                            { keyCode: Qh.LEFT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: gm.movePrevWord(t, n) },
                        ],
                        r
                    ).each(function(e) {
                        r.preventDefault();
            ...
            o.on('keydown', function(e) {
                ...
                o.on('keyup', function(e) {
                    ...
                    !1 === e.isDefaultPrevented() &&
                        ...
                        (n = e),
                        fC(
                            [{ keyCode: Qh.BACKSPACE, action: lC(kd, t) }, { keyCode: Qh.DELETE, action: lC(kd, t) }],
                            n
                        ));
                });
        },
        ...
        AC = function(e, t, n, r, o) {
            ...
            if (n !== e.getBody()) {
                ...
                if (kC(n, r, !0) && kC(n, r, !1)) EC(n, 'LI') ? i.insertAfter(l, TC(n)) : i.replace(l, n);
                    ...
                    EC(n, 'LI')
                        ? (i.insertAfter(l, TC(n)), l.appendChild(i.doc.createTextNode(' ')), l.appendChild(n))
        ...
        LC = function(a, e) {
            var t,
                ...
                E = function(e) {
                    ...
                    if (
                        (e || 'TABLE' === f || 'HR' === f ? ((t = C.create(e || m)), PC(a, t)) : (t = c.cloneNode(!1)),
                        (r = t),
                        !1 === oc(a))
                    )
                ...
                S = function(e) {
                    ...
                    for (
                        t = new oo(s, c),
                            Do.isText(s) && (e && 0 === o ? t.prev() : e || o !== s.nodeValue.length || t.next());
                        (n = t.current());
                ...
                T = function() {
                    (r = /^(H[1-6]|PRE|FIGURE)$/.test(f) && 'HGROUP' !== d ? E(m) : E()),
                        ic(a) && DC(C, l) && C.isEmpty(c) ? (r = C.split(l, c)) : C.insertAfter(r, c),
                        yC(a, r);
                };
                        ...
                        (s = (function(e, t, n, r, o) {
                            ...
                            if (!(a = m.getParent(r, m.isBlock)) || !DC(m, a)) {
                                ...
                                if (u && e.schema.isValidChild(l, d.toLowerCase())) {
                                    for (
                                        i = m.create(d), PC(e, i), u.parentNode.insertBefore(i, u), s = u;
                                        s && !m.isBlock(s);
                    ...
                    /^(LI|DT|DD)$/.test(f) && C.isEmpty(c)
                        ...
                        : (m && c === a.getBody()) ||
                          ...
                          Ta(c)
                              ...
                              ? T()
                              : S(!0)
                              ? ((r = c.parentNode.insertBefore(E(), c)), yC(a, RC(c, 'HR') ? r : c))
                              : ((t = ((b = N),
                                (y = b.cloneRange()),
                                y.setStart(b.startContainer, BC(!0, b.startContainer, b.startOffset)),
                                y.setEnd(b.endContainer, BC(!1, b.endContainer, b.endOffset)),
                                y).cloneRange()).setEndAfter(c),
                                (function(e) {
                                    for (
                                        ;
                                        Do.isText(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, '')),
                                            (e = e.firstChild);
                                    ...
                                    if (o) {
                                        ...
                                        for (r = i.length; r--; )
                                            ...
                                            (o.firstChild === o.lastChild && '' === o.firstChild.nodeValue)
                                                ...
                                                : (a = o) &&
                                                  'A' === a.nodeName &&
                                                  0 === Yt.trim(Na(a.innerText || a.textContent)).length &&
                                                  e.remove(o);
                                        var a;
                                    }
                                })(C, w, r),
        ...
        nx = function(r) {
            r.on('keydown', function(e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ((t = r),
                    (n = e),
                    fC([{ keyCode: Qh.SPACEBAR, action: lC(tx, t) }], n).each(function(e) {
                        n.preventDefault();
                    }));
            });
        },
        rx = function(e, t) {
            ...
            t.hasAttribute('data-mce-caret') &&
                (La(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t));
        },
        ox = function(e, t) {
            var n,
                r = ((n = e),
    ...
    function ux(u) {
        ...
        return (
            ...
            i &&
                ...
                (r = function() {
                    return (
                        !d.isCollapsed() && f.getParent(d.getStart(), f.isBlock) !== f.getParent(d.getEnd(), f.isBlock)
                    );
                }),
    ...
    var sx = function(e) {
        ...
        mx = function(t, e) {
            ...
            f.inline || (t.getElement().style.visibility = t.orgVisibility),
                ...
                t.readonly ||
                    (t.inline && 'static' === fx.getStyle(n, 'position', !0) && (n.style.position = 'relative'),
                ...
                (t.parser = ((o = dy((u = t).settings, u.schema)).addAttributeFilter(
                ...
                0 < t.contentStyles.length &&
                    ...
                    t.dom.addStyle(r)),
                ((i = t), i.inline ? fx.styleSheetLoader : i.dom.styleSheetLoader).loadAll(
                    t.contentCSS,
                    function(e) {
                        dx(t);
                    },
        ...
        px = function(e, t) {
            var n,
                ...
                (s = er.fromTag('iframe')),
                hr.setAll(s, i),
                hr.setAll(s, { id: n + '_ifr', frameBorder: '0', allowTransparency: 'true', title: r }),
                Er(s, {
                    width: '100%',
        ...
        hx = function(e, t) {
            var n = px(e, t);
            t.editorContainer &&
                ((gx.get(t.editorContainer).style.display = e.orgDisplay), (e.hidden = gx.isHidden(t.editorContainer))),
        ...
        Nx = function(t) {
            ...
            return (
                ...
                (u.aria_label = u.aria_label || vx.getAttrib(s, 'aria-label', t.getLang('aria.rich_text_area'))),
                ...
                k(o)
                    ? ((n.settings.theme = yx(o)),
                      ...
                      n.theme.init && n.theme.init(n, Jp.urls[o] || n.documentBaseUrl.replace(/\/$/, ''), n.$))
                    : (n.theme = {}),
                (i = t),
                (a = []),
                ...
                if (t.getElement() && Re.contentEditable) {
                    ...
                    o &&
                        ...
                        e.hidden_input &&
                            ...
                            (Ex.insertAfter(Ex.create('input', { type: 'hidden', name: n }), n),
                            (t.hasHiddenInput = !0)),
        ...
        Ox = function(r, e) {
            ...
            if (
                ...
                0 !== r.indexOf('/') || i || (r = ((t && t.protocol) || 'http') + '://mce_host' + r),
                    /^[\w\-]*:?\/\//.test(r) ||
                        ((n = e.base_uri ? e.base_uri.path : new Ox(document.location.href).directory),
                        '' == e.base_uri.protocol
    ...
    (Ox.prototype = {
        ...
        toRelative: function(e) {
            ...
            if ('./' === e) return e;
            if (
                ('mce_host' !== (e = new Ox(e, { base_uri: this })).host && this.host !== e.host && e.host) ||
                this.port !== e.port ||
    ...
    var Px = function(e, t, n) {
            ...
            return (
                'text' === t.format || Co(er.fromDom(n)) ? (t.content = r) : (t.content = Yt.trim(r)),
        ...
        Ux = function(u, s, c) {
            return (
                ...
                (c.set = !0),
                (c.content = Mx(s) ? '' : s),
                Mx(s) || c.no_events || (u.fire('BeforeSetContent', c), (s = c.content)),
                        ...
                        : ((t = u),
                          ...
                          0 === (r = s).length || /^\s+$/.test(r)
                              ? ((a = '<br data-mce-bogus="1">'),
                                ...
                                (i = ec(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase())
        ...
        qx = function(e) {
            if (!e.removed) {
                ...
                r && e.save({ is_removing: !0 }),
                    ...
                    !e.inline && r && ((i = e), zx.setStyle(i.id, 'display', i.orgDisplay)),
                    rp(e),
        ...
        (Yx.prototype = {
            ...
            hide: function() {
                ...
                e.hidden ||
                    ...
                    e.inline
                        ...
                        : (jx.hide(e.getContainer()), jx.setStyle(e.id, 'display', e.orgDisplay)),
                    (e.hidden = !0),
                    e.fire('hide'));
            },
            isHidden: function() {
            ...
            getContent: function(e) {
                return (
                    (t = this),
                    void 0 === (n = e) && (n = {}),
                    A.from(t.getBody()).fold(H('tree' === n.format ? new ty('body', 11) : ''), function(e) {
                        return Px(t, n, e);
                    })
                );
                var t, n;
            ...
            getContainer: function() {
                return (
                    this.container || (this.container = jx.get(this.editorContainer || this.id + '_parent')),
                    this.container
                );
            },
    ...
    var Gx,
        ...
        xw = function(t) {
            ...
            return (
                ...
                Qx.activeEditor === t && (Qx.activeEditor = 0 < bw.length ? bw[0] : null),
    ...
    gw(
        (Qx = {
            ...
            overrideDefaults: function(e) {
                var t, n;
                (t = e.base_url) &&
                    ((this.baseURL = new Ox(this.documentBaseURL).toAbsolute(t.replace(/\/+$/, ''))),
                    (this.baseURI = new Ox(this.baseURL))),
                    (n = e.suffix),
            ...
            init: function(r) {
                ...
                var c = function(e) {
                        var t = e.id;
                        return (
                            t || ((t = (t = e.name) && !fw.get(t) ? e.name : fw.uniqueId()), e.setAttribute('id', t)), t
                        );
                    },
                    l = function(e, t) {
            ...
            add: function(e) {
                ...
                return (
                    vw[e.id] === e ||
                        (null === t.get(e.id) && ('length' !== e.id && (vw[e.id] = e), vw.push(e), bw.push(e)),
                        Cw(!0),
                        (t.activeEditor = e),
        ...
        Ow = {
            ...
            findBestRelativePosition: function(e, t, n, r) {
                ...
                for (i = 0; i < r.length; i++)
                    if ((o = Dw(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y)
                        return r[i];
                return null;
            },
        ...
        qw = function(e, n) {
            ...
            if ('object' === t) {
                ...
                for (i in ((o = '{'), e))
                    e.hasOwnProperty(i) &&
                        (o +=
                            'function' != typeof e[i] ? (1 < o.length ? ',' + n : n) + i + n + ':' + qw(e[i], n) : '');
                return o + '}';
            }
            return '' + e;
        },
            ...
            send: function(e) {
                ...
                if (
                    ...
                    if (
                        ...
                        (t = $w.fire('beforeSend', { xhr: t, settings: e }).xhr).send(e.data),
                        !e.async)
                    )
                        return r();
                    setTimeout(r, 10);
        ...
        (Jw.prototype = {
            send: function(n) {
                ...
                ((n = Gw(this.settings, n)).success = function(e, t) {
                    ...
                    (n.data = Hw.serialize({ id: n.id || 'c' + this.count++, method: n.method, params: n.params })),
                    ...
                    return (
                        ...
                        (n.toHsv = function() {
                            return (
                                ...
                                (n = c),
                                (o = 0),
                                (i = Uw((e /= 255), Uw((t /= 255), (n /= 255)))) === (a = zw(e, zw(t, n)))
                                    ? { h: 0, s: 0, v: 100 * (o = i) }
                                    : ((r = (a - i) / a),
                                      {
                                          h: Vw(
